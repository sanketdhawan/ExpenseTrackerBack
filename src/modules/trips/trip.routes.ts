...
import { addTripBuddies, getTripBuddies, inviteTripBuddy } from './buddies/trip-buddy.controller';
...
router.post('/:tripId/buddies/invite', firebaseAuthMiddleware, inviteTripBuddy);
